describe('Payment Validation SA', () => {
    ...
    it('validates payment flow in SA', () => {
      ...
      cy.get('.countrySelectButton').type('Pakistan'); // Type in the input
      ...
      cy.contains('Pakistan')
        ...
        // Choose free fire
        cy.get('[href="/en/PK/productBundle/free-test-fire-5-610"]').click();
        cy.wait(30000)
        ...
        //NO AVAILABLE PAYMENT METHOD IN QATAR
        // Proceed with payment
