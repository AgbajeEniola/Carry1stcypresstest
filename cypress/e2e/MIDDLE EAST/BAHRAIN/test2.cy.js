describe('Payment Validation SA', () => {
    ...
    it('validates payment flow in SA', () => {
      ...
      cy.get('.countrySelectButton').type('Bahrain'); // Type in the input
      ...
      cy.contains('Bahrain')
        ...
        // Choose free fire
        cy.get('[href="/en/BH/productBundle/free-test-fire-5-610"]').click();
        cy.wait(30000)
        ...
        cy.wait(30000) 
        cy.contains('.card-content', 'Apple Pay')
        .should('be.visible')
        .click();  
  ...
  .type('66356743', { force: true }); // Use { force: true } to bypass the covering element
...
//asserting user can proceed to pay with Googlepay
