describe('Payment Validation SA', () => {
    ...
    it('validates payment flow in SA', () => {
      ...
      cy.get('.countrySelectButton').type('Kuwait'); // Type in the input
      ...
      cy.contains('Kuwait')
        ...
        // Choose free fire
        cy.get('[href="/en/KW/productBundle/free-test-fire-5-610"]').click();
        cy.wait(30000)
  ...
  .type('1805555', { force: true }); // Use { force: true } to bypass the covering element
